...
"""
tutorial-hooks-conf documentation build configuration file.
...
project = 'tutorial-hooks-conf'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'tutorial-hooks-conf'
...
#
# html_title = 'tutorial-hooks-conf v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Code for the Using openedx hooks for custom code talk at the 2023 openedx conf',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'tutorial_hooks_conf'),
                os.path.join(root_path, 'tutorial_hooks_conf/migrations')])
